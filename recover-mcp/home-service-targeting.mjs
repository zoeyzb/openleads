...
export function isCoreHomeServiceLead(lead={}){
  ...
  if(/\b(supplier|supply|distributor|distributors|wholesale|manufacturer|parts|retail store|equipment store|warranty|septic|motors|construction|excavation|excavating|roofing|landscaping|remodeling|rental|rentals)\b/.test(category)) return false;
