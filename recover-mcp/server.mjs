...
function inboxAppHtml() {
  ...
  function updateNotifyButton(){const b=q("notify");if(!("Notification" in window)){b.style.display="none";return}const on=Notification.permission==="granted";b.textContent=on?"●":"♢";b.title=on?"Notifications on":"Enable notifications";b.classList.toggle("notifyOn",on)}
