...
const summary={queued:0,running:0,complete:0,partial_complete:0,failed:0,cancelled:0,other:0,stored:0,qualified:0,stopped:0};
for(const id of ids){
...
console.log(JSON.stringify({ok:true,scope:"all_acquisitions",jobs:ids.length,before:summary,queue_cleared:true}));
await redis.quit();